...
#default.ndb.user                                = node.ndb.user.empty? ? (node.install.user.empty? ? "mysql" : node.install.user) : node.ndb.user
default.ndb.user                                = node['ndb'].attribute?('user') ? node['ndb']['user'] : (node['install']['user'].nil? ? "mysql" : node['install']['user'])
